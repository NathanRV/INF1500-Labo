...
#
# Generated by export_simulation on Tue Oct 08 20:11:18 -0400 2019
#
################################################################################
...
'-reset_run' switch to the './full_add_1B.sh' script.

./full_add_1B.sh -reset_run
...
./full_add_1B.sh -noclean_files

For more information on the script, please type './full_add_1B.sh -help'.
