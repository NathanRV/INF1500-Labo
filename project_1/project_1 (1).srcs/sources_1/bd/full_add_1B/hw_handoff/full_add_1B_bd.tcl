...
################################################################
# This is a generated script based on design: full_add_1B
#
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net A_1 [get_bd_ports A] [get_bd_pins xup_and2_0/a] [get_bd_pins xup_and2_2/a] [get_bd_pins xup_xor2_1/a]
  connect_bd_net -net B_1 [get_bd_ports B] [get_bd_pins xup_and2_0/b] [get_bd_pins xup_and2_1/b] [get_bd_pins xup_xor2_1/b]
  connect_bd_net -net CIN_1 [get_bd_ports CIN] [get_bd_pins xup_and2_1/a] [get_bd_pins xup_and2_2/b] [get_bd_pins xup_xor2_0/b]
  ...
  connect_bd_net -net xup_xor2_0_y [get_bd_ports S] [get_bd_pins xup_xor2_0/y]
  connect_bd_net -net xup_xor2_1_y [get_bd_pins xup_xor2_0/a] [get_bd_pins xup_xor2_1/y]
