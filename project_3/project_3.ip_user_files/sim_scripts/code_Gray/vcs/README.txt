...
#
# Generated by export_simulation on Tue Oct 22 11:21:36 -0400 2019
#
################################################################################
...
'-reset_run' switch to the './code_Gray.sh' script.

./code_Gray.sh -reset_run
...
./code_Gray.sh -noclean_files

For more information on the script, please type './code_Gray.sh -help'.
