...
################################################################
# This is a generated script based on design: code_Gray
#
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set E0 [ create_bd_port -dir I E0 ]
  set E1 [ create_bd_port -dir I E1 ]
  set E2 [ create_bd_port -dir I E2 ]
  set E3 [ create_bd_port -dir I E3 ]
  ...
  connect_bd_net -net E0_1 [get_bd_ports E0] [get_bd_pins xup_and2_5/a] [get_bd_pins xup_inv_3/a]
  connect_bd_net -net E1_1 [get_bd_ports E1] [get_bd_pins xup_and2_1/b] [get_bd_pins xup_and2_6/b] [get_bd_pins xup_inv_0/a]
  connect_bd_net -net E2_1 [get_bd_ports E2] [get_bd_pins xup_and2_0/b] [get_bd_pins xup_and2_2/a] [get_bd_pins xup_and2_4/a] [get_bd_pins xup_inv_1/a]
  connect_bd_net -net E3_1 [get_bd_ports E3] [get_bd_pins xup_and2_3/b] [get_bd_pins xup_and2_4/b] [get_bd_pins xup_inv_2/a]
  ...
  connect_bd_net -net xup_and2_2_y [get_bd_pins xup_and2_2/y] [get_bd_pins xup_or2_3/a]
  connect_bd_net -net xup_and2_3_y [get_bd_pins xup_and2_3/y] [get_bd_pins xup_or2_3/b] [get_bd_pins xup_or2_4/a]
  connect_bd_net -net xup_and2_4_y [get_bd_pins xup_and2_4/y] [get_bd_pins xup_or2_4/b]
  ...
  connect_bd_net -net xup_inv_0_y [get_bd_pins xup_and2_0/a] [get_bd_pins xup_and2_5/b] [get_bd_pins xup_inv_0/y]
  connect_bd_net -net xup_inv_1_y [get_bd_pins xup_and2_1/a] [get_bd_pins xup_and2_3/a] [get_bd_pins xup_inv_1/y]
  connect_bd_net -net xup_inv_2_y [get_bd_pins xup_and2_2/b] [get_bd_pins xup_inv_2/y]
  connect_bd_net -net xup_inv_3_y [get_bd_pins xup_and2_6/a] [get_bd_pins xup_inv_3/y]
  connect_bd_net -net xup_or2_0_y [get_bd_pins xlconcat_0/In1] [get_bd_pins xup_or2_0/y]
  connect_bd_net -net xup_or2_1_y [get_bd_pins xlconcat_0/In0] [get_bd_pins xup_or2_1/y]
  connect_bd_net -net xup_or2_3_y [get_bd_pins xlconcat_0/In2] [get_bd_pins xup_or2_3/y]
  connect_bd_net -net xup_or2_4_y [get_bd_pins xlconcat_0/In3] [get_bd_pins xup_or2_4/y]
