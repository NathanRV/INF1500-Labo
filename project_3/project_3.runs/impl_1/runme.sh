...
HD_PWD='D:/Users/Nathan/Documents/INF1500/Labo/project_3/project_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Code_Conversion_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Code_Conversion_wrapper.tcl -notrace
