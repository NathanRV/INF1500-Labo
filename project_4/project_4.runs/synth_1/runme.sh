...
HD_PWD='D:/Users/Nathan/Documents/INF1500/Labo/project_4/project_4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CompletLab4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CompletLab4.tcl
