...
HD_PWD='D:/Users/Nathan/Documents/INF1500/Labo/project_4/project_4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log CompletLab4.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source CompletLab4.tcl -notrace
