...
set_property -dict { PACKAGE_PIN R18 IOSTANDARD LVCMOS33 } [get_ports { S[4] }];
...
set_property -dict { PACKAGE_PIN U8 IOSTANDARD LVCMOS33 } [get_ports { B[4] }];
set_property -dict { PACKAGE_PIN R16 IOSTANDARD LVCMOS33 } [get_ports { R0 }];
set_property -dict { PACKAGE_PIN T13 IOSTANDARD LVCMOS33 } [get_ports { R1 }];