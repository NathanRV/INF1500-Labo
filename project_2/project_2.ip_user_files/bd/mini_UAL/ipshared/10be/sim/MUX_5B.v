...
module MUX_5B
  ...
  MUX_5B_ATAD_SPLIT_2_0_1 ATAD_SPLIT_2_0
       (.VIN(R1R0_1),
        .VOUT0(ATAD_SPLIT_2_0_VOUT0),
        .VOUT1(ATAD_SPLIT_2_0_VOUT1));
  MUX_5B_ATAD_SPLIT_5_0_4 ATAD_SPLIT_5_0
       (.VIN(ADD_1),
  ...
  MUX_5B_ATAD_SPLIT_5_0_5 ATAD_SPLIT_5_1
       (.VIN(SOUS_1),
  ...
  MUX_5B_ATAD_SPLIT_5_0_6 ATAD_SPLIT_5_2
       (.VIN(DIV_1),
  ...
  MUX_5B_ATAD_SPLIT_5_0_7 ATAD_SPLIT_5_3
       (.VIN(MIROIR_1),
  ...
  MUX_5B_MUX_1B_3_0 MUX_1B_4
       (.A0(ATAD_SPLIT_5_0_VOUT4),
        ...
        .R1(ATAD_SPLIT_2_0_VOUT1),
        .S(MUX_1B_4_S));
  MUX_5B_xlconcat_0_1 xlconcat_0
       (.In0(MUX_1B_0_S),
        .In1(MUX_1B_1_S),
        .In2(MUX_1B_2_S),
        .In3(MUX_1B_3_S),
