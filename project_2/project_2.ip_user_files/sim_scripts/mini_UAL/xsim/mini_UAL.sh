...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xil_defaultlib -L xlconcat_v2_1_3 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot mini_UAL xil_defaultlib.mini_UAL xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim mini_UAL -key {Behavioral:sim_1:Functional:mini_UAL} -tclbatch cmd.tcl -protoinst "protoinst_files/MIROIR_5B.protoinst" -protoinst "protoinst_files/mini_UAL.protoinst" -protoinst "protoinst_files/MUX_1B.protoinst" -protoinst "protoinst_files/MUX_5B.protoinst" -log simulate.log
}
