...
HD_PWD='D:/Users/Nathan/Documents/INF1500/Labo/project_5/project_5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CompletFeu.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CompletFeu.tcl
