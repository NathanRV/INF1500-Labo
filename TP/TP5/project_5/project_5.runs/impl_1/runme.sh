...
HD_PWD='D:/Users/Nathan/Documents/INF1500/Labo/project_5/project_5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log CompletFeu.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source CompletFeu.tcl -notrace
