...
module MIROIR_5B
  ...
  MIROIR_5B_ATAD_SPLIT_5_0_2 ATAD_SPLIT_5_0
       (.VIN(A_1),
  ...
  MIROIR_5B_ATAD_SPLIT_5_1_0 ATAD_SPLIT_5_1
       (.VIN(B_1),
  ...
  MIROIR_5B_xlconcat_0_1 xlconcat_0
       (.In0(xup_nor5_0_y),
        .In1(xup_nor5_0_y),
        .In2(xup_nor5_0_y),
        .In3(xup_nor5_0_y),
  ...
  MIROIR_5B_xup_nor5_0_1 xup_nor5_0
       (.a(xup_xor2_0_y),
        .b(xup_xor2_1_y),
        .c(xup_xor2_2_y),
        .d(xup_xor2_3_y),
        .e(xup_xor2_4_y),
        .y(xup_nor5_0_y));
  MIROIR_5B_xup_xor2_0_5 xup_xor2_0
