...
HD_PWD='D:/Users/Nathan/Documents/INF1500/Labo/project_3/project_3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Code_Conversion_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Code_Conversion_wrapper.tcl
