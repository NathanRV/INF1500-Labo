...
#
# Generated by export_simulation on Tue Oct 22 10:39:27 -0400 2019
#
################################################################################
...
'-reset_run' switch to the './Code_secret.sh' script.

./Code_secret.sh -reset_run
...
./Code_secret.sh -noclean_files

For more information on the script, please type './Code_secret.sh -help'.
