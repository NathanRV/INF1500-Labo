...
module MUX_1B
  ...
  MUX_1B_xup_and3_0_0 xup_and3_0
       (.a(A0_1),
        .b(xup_inv_0_y),
        .c(xup_inv_1_y),
        .y(xup_and3_0_y));
  MUX_1B_xup_and3_1_0 xup_and3_1
       (.a(A1_1),
        .b(R0_1),
        .c(xup_inv_1_y),
        .y(xup_and3_1_y));
  MUX_1B_xup_and3_2_0 xup_and3_2
       (.a(DIV_1),
        .b(xup_inv_0_y),
        .c(R1_1),
        .y(xup_and3_2_y));
  MUX_1B_xup_and3_3_0 xup_and3_3
       (.a(MIROIR_1),
        .b(R0_1),
        .c(R1_1),
        .y(xup_and3_3_y));
  MUX_1B_xup_inv_0_0 xup_inv_0
       (.a(R0_1),
        .y(xup_inv_0_y));
  MUX_1B_xup_inv_1_0 xup_inv_1
       (.a(R1_1),
        .y(xup_inv_1_y));
  MUX_1B_xup_or4_0_0 xup_or4_0
       (.a(xup_and3_0_y),
        .b(xup_and3_1_y),
        .c(xup_and3_2_y),
        .d(xup_and3_3_y),
