...
################################################################
# This is a generated script based on design: MUX_1B
#
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net A0_1 [get_bd_ports A0] [get_bd_pins xup_and3_0/a]
  connect_bd_net -net A1_1 [get_bd_ports A1] [get_bd_pins xup_and3_1/a]
  connect_bd_net -net DIV_1 [get_bd_ports A2] [get_bd_pins xup_and3_2/a]
  connect_bd_net -net MIROIR_1 [get_bd_ports A3] [get_bd_pins xup_and3_3/a]
  connect_bd_net -net R0_1 [get_bd_ports R0] [get_bd_pins xup_and3_1/b] [get_bd_pins xup_and3_3/b] [get_bd_pins xup_inv_0/a]
  connect_bd_net -net R1_1 [get_bd_ports R1] [get_bd_pins xup_and3_2/c] [get_bd_pins xup_and3_3/c] [get_bd_pins xup_inv_1/a]
  ...
  connect_bd_net -net xup_or4_0_y [get_bd_ports S] [get_bd_pins xup_or4_0/y]
